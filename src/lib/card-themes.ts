...
export const cardThemes: CardTheme[] = [
  ...
  base({
    id: "slate-wedge",
    name: "Slate Wedge",
    description: "Light gray card with dark trapezoid brand panel.",
    category: "monochrome",
    layout: "mod-slate-wedge",
    orientation: "landscape",
    size: "md",
    surface: "bg-[#E8E8E8]",
    text: "text-black",
  ...
  base({
    id: "wilson-split",
    name: "Wilson Split",
    description: "Dark split front with QR contact and centered logo back.",
    category: "dark",
    layout: "mod-wilson-split",
    orientation: "landscape",
    size: "md",
    surface: "bg-black",
    text: "text-white",
  ...
  base({
    id: "fluid-noir",
    name: "Fluid Noir",
    description: "Abstract organic shapes with bold monochrome contrast.",
    category: "abstract",
    layout: "mod-fluid-noir",
    orientation: "landscape",
    size: "md",
    surface: "bg-white",
    text: "text-black",
  ...
  base({
    id: "argentum-dark",
    name: "Argentum Dark",
    description: "Chrome chevron luxury card with neumorphic pods.",
    category: "luxury",
    layout: "mod-argentum",
    orientation: "landscape",
    size: "md",
  ...
  base({
    id: "ribbon-noir",
    name: "Ribbon Noir",
    description: "Black card with folded white ribbon accents.",
    category: "dark",
    layout: "mod-ribbon-noir",
    orientation: "landscape",
    size: "md",
    surface: "bg-black",
    text: "text-white",
  ...
  base({
    id: "crimson-pill",
    name: "Crimson Pill",
    description: "Dark card with red and gray pill bars and QR back.",
    category: "bold",
    layout: "mod-crimson-pill",
    orientation: "landscape",
    size: "md",
    surface: "bg-black",
    text: "text-white",
  ...
  base({
    id: "ampere-red",
    name: "Ampere Red",
    description: "White U-shape brand front with bold red logo back.",
    category: "bold",
    layout: "mod-ampere",
    orientation: "landscape",
    size: "md",
  ...
  base({
    id: "taupe-geo",
    name: "Taupe Geo",
    description: "Charcoal and sand geometric split with dot accents.",
    category: "geometric",
    layout: "mod-taupe-geo",
    orientation: "landscape",
    size: "md",
    surface: "bg-[#2D2D2D]",
    text: "text-[#C4A882]",
    subtext: "text-[#C4A882]/75",
    accent: "bg-[#C4A882]",
    accentText: "text-[#2D2D2D]",
    pro: true,
  }),
  base({
    id: "block-dark",
    name: "Block Dark",
    description: "Geometric black card with layered block accents.",
    category: "professional",
    layout: "mod-block-dark",
    orientation: "landscape",
    size: "md",
    surface: "bg-black",
    text: "text-white",
