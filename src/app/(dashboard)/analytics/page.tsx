        ...
        {cards.map((card) => {
          ...
          return (
            <Link
              ...
              className="group rounded-xl border border-border bg-card p-4 transition-shadow hover:shadow-lg hover:shadow-black/5"
            >
              ...
              <div className="mt-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {card.viewCount.toLocaleString()} total views · {theme.name}
                </p>
              </div>
            </Link>
          );
